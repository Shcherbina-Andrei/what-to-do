...
function TaskCard({task}: TaskCardProps): JSX.Element {
  ...
  return (
    <article className="task-card">
      <input className="task-card__input" type="text" value={task.description} disabled={!isEditing}/>
      <div className="task-card__controls">
        <button className="task-card__button task-card__button--edit" type="button" onClick={() => setIsEditing(!isEditing)}>
